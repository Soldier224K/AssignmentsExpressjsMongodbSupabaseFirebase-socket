...
('BMW', 'X5', 2023, 'SUV', 6000.00, 'Petrol', 7, 'available'),
('Mercedes-Benz', 'C-Class', 2023, 'Luxury', 7500.00, 'Diesel', 5, 'available'),
('Honda', 'City', 2022, 'Sedan', 2200.00, 'Petrol', 5, 'available'),
('Hyundai', 'i20', 2023, 'Hatchback', 1600.00, 'Petrol', 5, 'available');
